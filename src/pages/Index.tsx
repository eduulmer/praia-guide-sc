      ...
      <section className="relative h-[70vh] min-h-[480px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 max-w-xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            Governador Celso Ramos com mais de 40 praias e tradição açoriana preservada. Lar de aproximadamente 100 golfinhos, baleias migratórias e um dos melhores pontos de mergulho do Brasil. O município combina turismo sustentável, pesca artesanal autêntica e uma comunidade receptiva
          </p>
      ...
      <section className="py-16 bg-sand-gradient">
        <div className="container">
          ...
          <p className="text-center text-muted-foreground mb-10 max-w-lg mx-auto">
            Nossa recomendação lugares e experiências para sua estadia
          </p>
      ...
      <section className="py-16">
        <div className="container max-w-2xl text-center">
          <h2 className="font-display text-2xl font-bold text-foreground mb-4 mx-0">
            Bem-vindo à Feito Maré House! 🏖️
          </h2>
